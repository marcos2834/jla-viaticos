...
export default async function handler(req,res){
  ...
  try{
    ...
    await sheets.spreadsheets.values.append({spreadsheetId:SHEET_ID,range:'Movimientos!A:AF',valueInputOption:'RAW',insertDataOption:'INSERT_ROWS',requestBody:{values:[row]}});
