...
if(!validateCuil(cuil)){setCuilError('Ingresá un CUIL válido (11 dígitos). Ej: 20-12345678-9');return;}
const id={nombre:nombre.trim(),sociedad,tarjeta:tarjeta.trim().slice(-4)||'',cuil:cuil.trim()};
...
<label style={styles.label}>CUIL *</label>
<input
  style={{...styles.input,borderColor:cuilError?colors.red:undefined}}
  value={cuil}
  ...
  required
/>
{cuilError&&<p style={{color:colors.red,fontSize:'12px',marginTop:'4px'}}>{cuilError}</p>}
</div>
<div style={{marginBottom:'18px'}}>
